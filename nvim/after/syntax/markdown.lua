...
vim.cmd([[syntax match todoCheckbox '\v\s*(-|\*)\s\[-\]'hs=e-4 conceal cchar=󰅗]])
vim.cmd([[syntax match todoCheckbox '\v\s*(-|\*)\s\[\.\]'hs=e-4 conceal cchar=󱗜]])
vim.cmd([[syntax match todoCheckbox '\v\s*(-|\*)\s\[o\]'hs=e-4 conceal cchar=󱗜]])
