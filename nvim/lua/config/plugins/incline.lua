    ...
    data = {
        config = function(incline)
            ...
            local function render(props)
                ...
                elseif vim.b[props.buf].term_title then
                    filename = vim.b[props.buf].term_title
                    ft_icon = icons.lsp.cmdline
                    _, ft_color = devicons.get_icon_color_by_filetype("bash")
                end
            ...
            incline.setup({
                ...
                render = render,
                debounce_threshold = { rising = 10, falling = 30 },
            })
        end,
    },
}
