    ...
    data = {
        config = function(dashboard)
            ...
            local function generate_footer()
                local installer = require("config.installer")
                local plugins_installed = ("%s  %d plugins installed (%.2f ms)"):format(
                    icons.misc.package,
                    installer.plugin_count(),
                    installer.loadtime()
                )
                ...
                vim.list_extend(quote, require("config.utils.quotes").get_random())
                ...
                config = {
                    ...
                    center = {
                        ...
                        },
                        {
                            ...
                            key = "p",
                            key_hl = key_hl,
                            action = "lua vim.pack.update(nil)",
                        },
                        {
